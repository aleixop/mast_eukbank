...
- [`1-overall_analysis.Rmd`](1-overall_analysis.Rmd): Figure 2, Tables S2-S4, Figure S8
...
- [`data/vegan/`](data/vegan/): NMDS and PERMANOVA analyses data used for Figure 2.

Additionaly, all currently available MAST references (used in this study) can be found [here](data/trees/tableS1.tsv).
